                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="contact-info">
                            <h2 style="font-family: 'RocknRoll One', sans-serif;font-size:30px;">Our Office</h2><br>
                    ...
                    <div class="col-lg-4">
                        <div class="contact-info">
                            <h2 style="font-family: 'RocknRoll One', sans-serif;font-size:30px;">Our Store</h2><br>
                    ...
                    <div class="col-lg-4">
						...
						<?php
							if(isset($_SESSION['con_msg'])){
								echo "<p>". $_SESSION['con_msg'] ."</p>";
								unset($_SESSION['con_msg']);
							}
						?>
                            <form action="../function/functions.php" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="con_name" placeholder="Your Name" />
                                    </div>
                                    <div class="col-md-6">
                                        <input type="email" class="form-control" name="con_mail" placeholder="Your Email" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="con_subject" placeholder="Subject" />
                                </div>
                                <div class="form-group">
                                    <textarea class="form-control" rows="5" name="con_message" placeholder="Message"></textarea>
                                </div>
                                <div><button class="btn" name="con_submit">Send Message</button></div>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-12">
